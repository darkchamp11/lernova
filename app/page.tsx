      ...
      <section className="pt-32 pb-20 md:pt-48 md:pb-32 px-6 overflow-hidden relative">
        ...
        <div className="container mx-auto max-w-5xl text-center relative z-10">
          ...
          <p className="text-lg md:text-xl text-slate-600 mb-12 max-w-2xl mx-auto leading-relaxed">
            Lernova is your intelligent learning companion. It adapts to your skill level, tests
            your knowledge in real-time, and recommends the perfect courses to accelerate your
            growth.
          </p>
        ...
        <div className="container mx-auto px-6 max-w-6xl relative z-10">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">
              Why learn with Lernova?
            </h2>
            <p className="text-slate-600 max-w-2xl mx-auto text-lg">
              Our platform uses advanced heuristics and local AI to provide a learning experience
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="p-8 rounded-2xl bg-slate-50 border border-slate-100 hover:shadow-xl transition-shadow duration-300 group">
              ...
              <p className="text-slate-600 leading-relaxed">
                Our heuristic engine analyzes your test scores to intelligently recommend beginner,
                intermediate, or advanced content precisely when you need it.
              </p>
            </div>
            ...
            <div className="p-8 rounded-2xl bg-slate-50 border border-slate-100 hover:shadow-xl transition-shadow duration-300 group">
              ...
              <p className="text-slate-600 leading-relaxed">
                Test your knowledge instantly. Lernova generates unique, difficulty-adjusted
                questions on the fly using a local LLM to ensure you truly understand the material.
              </p>
            </div>
            ...
            <div className="p-8 rounded-2xl bg-slate-50 border border-slate-100 hover:shadow-xl transition-shadow duration-300 group">
              ...
              <p className="text-slate-600 leading-relaxed">
                Watch your skills grow. Our comprehensive dashboard features radar charts mapping
                your knowledge vectors and bar charts tracking your recent scores.
              </p>
            </div>
          </div>
        </div>
